...
class UrLineCircle:
    ...
    def move_ee(self,ur5_pub,q_now_t,deltax,cn,flagx,flagy):
        q_new_from_jacabian=self.caculate_vlocity_by_jocabian_v1(cn,q_now_t,deltax,flagx,flagy).tolist()[0]
...
def main():
    ...
    #velocity 1/30*detax*250=0.4---->0.048m/s
    ...
    while not rospy.is_shutdown():
        if len(ur_reader.ave_ur_pose)!=0:
            ...
            if go_back_start_flag == 1:
                ...
                cn = 1
                go_back_start_flag = 0
                urc.control_electric_switch(2,"55C8190000F055")#open electric relay
